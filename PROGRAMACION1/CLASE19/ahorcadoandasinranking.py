...
def main_menu():
    ...
    while running:
        ...
        draw_text(screen, translate("Hangman Game"), 48, *TITLE_POS)
        ...
        draw_button(translate("Salir"), WIDTH / 2 - BUTTON_WIDTH / 2, BUTTON_START_Y + BUTTON_SPACING, BUTTON_WIDTH, BUTTON_HEIGHT, WHITE, (200, 200, 200), pygame.quit)

        # Draw ranking
        draw_text(screen, "Ranking", 48, WIDTH / 2, 50)
        #show_ranking()
